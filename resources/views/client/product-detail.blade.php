                                                               ...
                                                               >
                                                                ...
                                                                <li>
                                                                    <div class="form-check">
                                                                        <input type="radio" 
                                                                            id="radio_color_{{ $id }}" name="product_color_id" value="{{ $id }}">
                                                                        <label class="form-check-label" style="background:{{ $name }};" for="radio_color_{{ $id }}">Chọn {{ $name }}</label>
                                                                    </div>
                                                                </li>
                                                                @endforeach
                                                ...
                                                <div class="uk-margin">
                                                    <div
                                                        ...
                                                        <div class="uk-grid-small uk-child-width-1-1" uk-grid>
                                                            <div><del class="uk-text-meta">{{ $product->price_regular }}</del>
                                                                <div class="tm-product-price">{{ $product->price_sale }}</div>
                                                            </div>
                                                            <div>
                                                                <div class="uk-grid-small" uk-grid>
                                                                    <div>
