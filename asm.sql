...
--
-- Host: localhost:3306
-- Generation Time: Jul 20, 2024 at 11:02 AM
...
CREATE TABLE `product_variants` (
  ...
  `quatity` bigint UNSIGNED NOT NULL DEFAULT '1',
...
--
ALTER TABLE `product_variants`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25001;
